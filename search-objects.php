<?php
require_once(__DIR__ . "/../templates/bootstrap.php"); // assicura $db_obj e session
...
<div class="row g-4">
    <?php if(empty($items)): ?>
        <div class="col-12">
            <div class="alert alert-info">Nessuna segnalazione presente.</div>
        </div>
    <?php endif; ?>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card">
                <?php if(!empty($it['foto'])): ?>
                    <img src="uploads/<?php echo htmlspecialchars($it['foto']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($it['nome']); ?>">
                <?php endif; ?>
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <?php if(isUserLoggedIn()): ?>
                            <form action="/claim-api.php" method="POST" class="d-flex gap-2 w-100">
                                ...
                                <button type="submit" class="btn btn-success w-100">È mio</button>
                            </form>
                        <?php else: ?>
